...
import img2 from "../../../img/ProgressBar/TIL2.png";
import WritingPageBtnWrap from "../../WritingPageBtn";

//Step by Step TIL 회고 페이지 2
interface TIL2Props {
  content: string[];
  handleComplete: () => void;
  inputContent: string;
      ...
      <StepByStepWrap>
        ...
        <div className="mainContent_container">
          ...
          <div className="main_text_container">
            <p>
              <span style={{ fontWeight: 700 }}>개선</span> - 오늘의 나는 어떤
              문제를 겪었는지,
            </p>
            <p>앞으로 어떻게 해결할 것인지 작성해주세요.</p>
          </div>
          <div>
            <textarea
