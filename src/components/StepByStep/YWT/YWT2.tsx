...
import img2 from "../../../img/ProgressBar/YWT2.png";
import WritingPageBtnWrap from "../../WritingPageBtn";

//Step by Step YWT 회고 페이지 2
interface YWT2Props {
  content: string[];
  handleComplete: () => void;
  inputContent: string;
      ...
      <StepByStepWrap>
        ...
        <div className="mainContent_container">
          <div className="mainContent_Btn">
            <p>배운 것들</p>
            <p>(わかったこと-wakattakoto)</p>
          </div>
          <div className="main_text_container">
            <p>
              <span style={{ fontWeight: 700 }}>배운 점과 시사점</span>을
              작성해주세요.
            </p>
          </div>
          <div>
