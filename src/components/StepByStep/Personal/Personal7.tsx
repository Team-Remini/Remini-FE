...
import img7 from "../../../img/ProgressBar/Personal7.png";
import WritingPageBtnWrap from "../../WritingPageBtn";

//Step by Step Personal 회고 페이지 7
interface Personal7Props {
  content: string[];
  handleComplete: () => void;
  inputContent: string;
...
export default function Personal7({
  content,
  handleComplete,
  inputContent,
  setInputContent,
      ...
      <StepByStepWrap>
        ...
        <div className="mainContent_container">
          <div className="main_text_container">
            <p>
              <span style={{ fontWeight: 700 }}>하겠다고 해놓고 안 한 일</span>
              은 어떤 것인지 작성해주세요.
            </p>
          </div>
          <div>
