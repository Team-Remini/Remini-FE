...
import img10 from "../../../img/ProgressBar/Personal10.png";
import WritingPageBtnWrap from "../../WritingPageBtn";

//Step by Step Personal 회고 페이지 10
interface Personal10Props {
  content: string[];
  handleComplete: () => void;
  inputContent: string;
...
export default function Personal10({
  content,
  handleComplete,
  inputContent,
  setInputContent,
    ...
    <>
      <StepByStepWrap>
        <div className="progressBar_container">
          <img src={img10} alt="progressBar" />
        </div>
        <div className="mainContent_container">
          <div className="main_text_container">
            <p>
              <span style={{ fontWeight: 700 }}>삶에서 더 하고 싶은 일</span>은
              어떤 것인지 작성해주세요.
            </p>
          </div>
          <div>
