...
import img4 from "../../../img/ProgressBar/FourL4.png";
import WritingPageBtnWrap from "../../WritingPageBtn";
import { useNavigate } from "react-router-dom";

//Step by Step FourL 회고 페이지 4
interface FourL4Props {
  content: string[];
  handleComplete: () => void;
  inputContent: string;
...
export default function FourL4({
  content,
  inputContent,
  setInputContent,
  ...
  const handleNext = () => {
    if (inputContent.trim().length > 0) {
      ...
      localStorage.setItem("StepByStep_FourL", JSON.stringify(updatedContent)); // 작성 완료 시 content 배열을 localStorage에 저장
    }
  };
      ...
      <StepByStepWrap>
        ...
        <div className="mainContent_container">
          ...
          <div className="main_text_container">
            <p>
              <span style={{ fontWeight: 700 }}>바라는 것</span>을 작성해주세요.
            </p>
          </div>
          <div>
            <textarea
