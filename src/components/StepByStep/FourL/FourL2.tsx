...
import img2 from "../../../img/ProgressBar/FourL2.png";
import WritingPageBtnWrap from "../../WritingPageBtn";

//Step by Step FourL 회고 페이지 2
interface FourL2Props {
  content: string[];
  handleComplete: () => void;
  inputContent: string;
...
export default function FourL2({
  content,
  handleComplete,
  inputContent,
  setInputContent,
      ...
      <StepByStepWrap>
        ...
        <div className="mainContent_container">
          ...
          <div className="main_text_container">
            <p>
              <span style={{ fontWeight: 700 }}>배운 것</span>을 작성해주세요.
            </p>
          </div>
          <div>
            <textarea
